// ─────────────────────────────────────────────────────────────────────────────
//  IdealOne OMS — Common Marketplace Types
//  All marketplace adapters must use these formats at their boundaries.
// ─────────────────────────────────────────────────────────────────────────────
...
export type MarketplaceChannel =
  ...
  | 'shopee'
  | 'tiktok'
  | 'api2cart'        // paid multi-cart connector
  | 'zetpy'           // paid multi-channel connector
  | 'channelengine';  // paid multi-channel connector
...
// ── Adapter interface ────────────────────────────────────────────────────────
//  Every marketplace connector must implement this.
...
// ── OAuth meta (for connectors that support it) ──────────────────────────────
