...
const SHOPIFY_STATUS = { paid: 'processing', authorized: 'confirmed', pending: 'pending', voided: 'cancelled', refunded: 'cancelled' };

function fromShopify(order, clientName) {
  ...
  let status = SHOPIFY_STATUS[order.financial_status] || 'pending';
...
module.exports = { fromLazada, fromShopee, fromTikTok, fromShopify };
