...
function getTenantDb(tenantId) {
  ...
  // Virtual Item Fulfillment Tracking
  db.exec(`
    CREATE TABLE IF NOT EXISTS virtual_item_fulfillment (
      id TEXT PRIMARY KEY,
      order_id TEXT NOT NULL,
      client_id TEXT NOT NULL,
    ...
    CREATE INDEX IF NOT EXISTS idx_virtual_fulfillment_client ON virtual_item_fulfillment(client_id);
    CREATE INDEX IF NOT EXISTS idx_virtual_fulfillment_order ON virtual_item_fulfillment(order_id);
    CREATE INDEX IF NOT EXISTS idx_virtual_fulfillment_status ON virtual_item_fulfillment(status);
  `);
