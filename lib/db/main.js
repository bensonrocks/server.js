...
// Migrate: upgrade accounts still using the old blank-password hash
db.prepare("UPDATE staff_users SET password_hash = ? WHERE username = 'administrator' AND password_hash = ?")
  .run(_sha256(DEFAULT_ADMIN_PW), _sha256(''));
