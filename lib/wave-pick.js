...
/**
 * Record a consolidated scan against the wave's pick list. Mutates `wave`.
...
function recordPickScan(wave, sku, qtyScanned, meta = {}) {
  ...
  wave.pickScanLog.push({ sku, location: entry.location, qty, at: new Date().toISOString(), by: meta.by || null, eventId: meta.eventId || null });
