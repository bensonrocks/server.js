...
function binLotsForSku(clientId, sku, strategy = 'fefo') {
  ...
  const order = strategy === 'fifo'
    ? 'received_at ASC, (expiry_date IS NULL), expiry_date ASC, id ASC'
...
module.exports = {
  ...
  createLocation, getLocations, updateLocation, locationOccupancy, stockByLocation,
  transferStock, placeStock, locationStockForClient,
  binLotsForSku, suggestLocationForSku, allocatePick, consumeAllocations,
  // Suppliers
