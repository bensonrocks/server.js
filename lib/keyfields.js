...
function buildRow(lineNum, order, line) {
  ...
  return {
    ...
    'd-expdate':      null,
    'd-priority':     null,
    'd-shaddr1':      order.waybill_number   || null,   // tracking no.
    'd-shaddr2':      order.delivery_address || null,   // delivery addr
    'd-shaddr3':      null,
    'd-shaddr4':      null,
    'd-shzipcode':    null,
...
const COLUMN_SAMPLES = {
  ...
  'd-expdate':      '',
  'd-priority':     '',
  'd-shaddr1':      'WAYBILL-NO',
  'd-shaddr2':      '123 Delivery Street, Singapore',
  'd-shaddr3':      '',
  'd-shaddr4':      '',
  'd-shzipcode':    '',
  'd-shtotel':      '91234567',
