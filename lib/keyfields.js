...
function mapRow(rawRow, detected = {}) {
  ...
  return {
    ...
    // Never used to identify the SKU (scoreSku() deliberately excludes these
    // same column names — see LOCATION_CODE_PAT note above) — this is purely
    // an auxiliary field for location-sorted wave picking downstream.
    location: String(
      n.location      ??
      n.loc           ??
      n.bin           ??
