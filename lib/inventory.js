...
module.exports = function createInventory(db) {
  ...
  function getStats({ clientId } = {}) {
    ...
    return { totalSKUs: rows.length, lowStock: lowStock.length, outOfStock: outOfStock.length, totalValue, categories, clientId };
  }
  ...
  return { getAll, get, upsert, remove, adjust, deductOrder, movements, getStats, velocity };
};
